...
/**
 * REST controller for managing {@link com.carmignac.data.dico.domain.Source}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SourceResource {
    ...
    public ResponseEntity<Source> partialUpdateSource(
        ...
        Optional<Source> result = sourceRepository
            ...
            .map(
                existingSource -> {
                    if (source.getIdGloden() != null) {
                        existingSource.setIdGloden(source.getIdGloden());
                    }
                    ...
                    if (source.getUpdateDate() != null) {
                        existingSource.setUpdateDate(source.getUpdateDate());
                    }
                    if (source.getCreationDate() != null) {
                        existingSource.setCreationDate(source.getCreationDate());
                    }
