...
public class Attribute implements Serializable {
    ...
    public SourcePriority getType() {
        return this.type;
    }

    public Attribute type(SourcePriority sourcePriority) {
        this.setType(sourcePriority);
        return this;
    }

    public void setType(SourcePriority sourcePriority) {
        this.type = sourcePriority;
    }

    public BusinessObject getType() {
        return this.type;
    }

    public Attribute type(BusinessObject businessObject) {
        this.setType(businessObject);
        return this;
    }

    public void setType(BusinessObject businessObject) {
